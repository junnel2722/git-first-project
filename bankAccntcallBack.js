    ...
    createBankAccount(getCurrentBalance, accountName);
    createBankAccount(withdrawMoney, accountName, 5);
    createBankAccount(getCurrentBalance, accountName);
    createBankAccount(depositMoney, accountName, 100);
    createBankAccount(getCurrentBalance, accountName);
    createBankAccount(withdrawMoney, accountName, 55);
    createBankAccount(getCurrentBalance, accountName);
    createBankAccount(depositMoney, accountName, 26);
    createBankAccount(getCurrentBalance, accountName);
    createBankAccount(withdrawMoney, accountName, 100);
    createBankAccount(getCurrentBalance, accountName);
